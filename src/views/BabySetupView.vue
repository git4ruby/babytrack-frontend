  ...
  <div class="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex items-center justify-center px-4">
    <div class="w-full max-w-md">
      <div class="text-center mb-8">
        ...
        <h1 class="text-2xl font-black text-gray-900 mt-4">Welcome to BabyTrack!</h1>
        <p class="text-gray-500 mt-1">Let's set up your baby's profile to get started</p>
      </div>
            ...
            <div class="flex gap-3">
              <button
                ...
                :class="[
                  ...
                  gender === g.v ? 'border-blue-500 bg-blue-50 text-blue-700' : 'border-gray-200 text-gray-600 hover:border-gray-300'
                ]"
              >
                {{ g.e }} {{ g.l }}
              </button>
