    ...
    <div class="w-full max-w-md">
      ...
      <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-xl shadow-gray-200/50 dark:shadow-none p-8">
        <div v-if="success" class="text-center space-y-4">
          ...
          <h2 class="text-lg font-bold text-gray-900 dark:text-white">Password reset!</h2>
          <p class="text-sm text-gray-500 dark:text-slate-400">You can now sign in with your new password.</p>
